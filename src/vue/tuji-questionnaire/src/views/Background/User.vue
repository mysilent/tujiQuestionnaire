<template>
    <div>
        <div style="margin: 10px 0 " >
            <el-input v-model="selectForm.username" @blur="load" style="width: 200px" placeholder="请输入账户名" :suffix-icon="User"></el-input>
          <el-input v-model="selectForm.userId" style="width: 200px" placeholder="请输入ID号" :suffix-icon="Lock" class="ml-5"></el-input>
            <el-input v-model="selectForm.email" style="width: 200px" placeholder="请输入邮箱" :suffix-icon="Message" class="ml-5"></el-input>
            <el-input v-model="selectForm.phone" style="width: 200px" placeholder="请输入手机号" :suffix-icon="Phone" class="ml-5"></el-input>
            <el-button class="ml-5" type="primary" @click="load">搜索</el-button>
        </div>
        <div style="margin: 10px 0">
            <el-button type="danger"  @click="deleteAll">批量封禁</el-button>
        ...
        >
            ...
            <el-table-column label="操作">
                <template #default="{row}">
                  <el-button :type="getButtonType(row.state)" @click="updateState(row.state)">
...
import {findPage} from "@/axios/api/Background";
